...
# Customized OpenSearch with security retained for SEC-06 HTTPS/auth; used by Compose and Helm.
target "opensearch" {
  inherits   = ["_release-common"]
...
# Change trail: @MinhKhoa2209 - 2026-07-23 - Retain the OpenSearch SEC-06 security contract.
