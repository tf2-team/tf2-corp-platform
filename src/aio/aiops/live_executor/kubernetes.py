...
class KubernetesDeploymentGateway:
    ...
    def snapshot(self, namespace: str, name: str) -> dict[str, Any]:
        response = self._client.get(self._deployment_path(namespace, name))
        response.raise_for_status()
        return self._snapshot_from_deployment(response.json())
    ...
    @staticmethod
    def _snapshot_from_deployment(deployment: dict[str, Any]) -> dict[str, Any]:
