...
class SettingsTest(unittest.TestCase):
    ...
    def test_hyperparameters_load_from_config_file(self):
        ...
        self.assertEqual(config["rca"]["anomaly"]["algorithm_weights"], {"robust_drift": 0.8, "ewma_stl": 0.8, "isolation_forest": 0.2, "slow_drift": 1.0})
        ...
        self.assertEqual(config["rca"]["anomaly"]["min_tail_anomaly_buckets"]["cpu"], 5)
        ...
        self.assertEqual(config["rca"]["anomaly"]["min_tail_anomaly_buckets"]["socket_io"], 5)
        ...
        self.assertEqual(config["rca"]["anomaly"]["slow_drift"]["metrics"]["memory"]["min_total_change"], 5242880.0)
        self.assertEqual(config["rca"]["min_points"], 30)
        self.assertEqual(config["rca"]["anomaly"]["log_correlation_window_seconds"], 300)
        ...
        self.assertEqual(config["incident"]["count_reset_seconds"], 900)
        self.assertEqual(config["incident"]["notification_cooldown_seconds"], 900)
        self.assertEqual(config["incident"]["rca_dedup_seconds"], 900)
