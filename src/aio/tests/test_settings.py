...
class SettingsTest(unittest.TestCase):
    ...
    def test_hyperparameters_load_from_config_file(self):
        ...
        self.assertEqual(config["rca"]["anomaly"]["algorithm_weights"], {"ewma_stl": 0.4, "isolation_forest": 0.25})
        ...
        self.assertEqual(config["rca"]["anomaly"]["bocpd_hazard_lambda"], 50)
        self.assertEqual(config["rca"]["anomaly"]["bocpd_max_metrics"], 8)
        self.assertEqual(config["rca"]["anomaly"]["bocpd_max_points"], 120)
        ...
        self.assertEqual(config["rca"]["combined"], {"graph_weight": 0.5, "robust_weight": 0.5})
