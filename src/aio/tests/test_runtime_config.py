...
class RuntimeConfigTest(unittest.TestCase):
    ...
    def test_prometheus_services_expand_generated_metrics(self):
        ...
        self.assertIn("redis_net_input_bytes_total", config.prometheus_queries["valkey_cart.socket_io_bytes_per_second"])
    ...
    def test_registry_owns_one_second_collection_contract(self):
        ...
        self.assertEqual(profile.lookback_seconds // profile.detector_bucket_seconds, 240)
