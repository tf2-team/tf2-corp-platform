...
[shared semantic cache guide](caching/semantic-cache-implementation-guide.md) và [Shopping Copilot cache runbook](caching/shopping-copilot-dod-evidence-runbook.md).
